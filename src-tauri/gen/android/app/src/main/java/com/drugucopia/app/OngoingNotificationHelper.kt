...
object OngoingNotificationHelper {
    ...
    fun show(context: Context, id: Int, title: String, body: String) {
        ...
        // Without it, manager.notify() throws SecurityException which, if
        // uncaught in JNI, crashes the app. Guard here explicitly so even
        // if Rust's exception_check somehow fails, we never crash.
